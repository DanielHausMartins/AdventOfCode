...
def process_cycle() :
	global CLOCK, INSTRUCTION_CATALOG, CHECK_CYCLES, TOTAL_SIG_STR
	CRT_move_sprite()
...
def CRT_reset() :
	global CRT
	CRT = [[" " for i in range(CRT_WIDTH)] for _ in range(CRT_HEIGHT)]
...
# Part 1
#print(f"Total signal strength : {TOTAL_SIG_STR}")
mywindow.addstr(10,0, "Press any key to end program.")
mywindow.getch()
curses.endwin()
